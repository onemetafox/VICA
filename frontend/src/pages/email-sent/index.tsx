...
const EmailSent = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-5 bg-lightGray min-w-screen">
      <div className="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
        <h3 className="text-2xl">Thanks for signing up for VICA Inc!</h3>
        ...
        <p>We're happy you're here. Check Your email to Verify your account.</p>
        <div className="mt-4">
          <button
            type="button"
          ...
          <p className="mt-4 text-sm">
            If you’re having trouble with the "Verifying Email Address" , Please
            Contact the support
          </p>
        </div>
      </div>
